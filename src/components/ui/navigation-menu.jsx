...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 hover:bg-neutral-100",
  {
    variants: {},
    defaultVariants: {},
  }
...
const NavigationMenuTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronDown
      className="relative top-[1px] ml-1 h-3 w-3 text-neutral-600 transition duration-300 group-data-[state=open]:rotate-180"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
