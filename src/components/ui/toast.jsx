...
const ToastAction = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "hover:bg-neutral-200 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2",
...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <button
    ...
    className={cn(
      ...
      "hover:text-neutral-700 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-purple-600",
...
const ToastTitle = React.forwardRef(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("text-sm font-semibold text-neutral-900", className)} {...props} />
));
ToastTitle.displayName = "ToastTitle";

const ToastDescription = React.forwardRef(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("text-sm text-neutral-600 opacity-90", className)} {...props} />
));
