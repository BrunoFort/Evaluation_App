...
const CommandInput = React.forwardRef(({ className, ...props }, ref) => (
  <div
    className="flex items-center border-b border-neutral-300 px-3"
    cmdk-input-wrapper=""
  >
...
const CommandItem = React.forwardRef(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      ...
      "hover:bg-neutral-100 data-[selected=true]:bg-accent data-[selected=true]:text-accent-foreground",
